...
Indeed, when the spacing is higher, the dimension of the subspaces $S_i$ is increased and the dimensionality reduction induced by Theorem~\ref{th_multisens_subspace}, compared to Theorem~\ref{th_2sens_subspace}, has a higher impact.
...
\begin{figure}[htb]
	...
	%\subcaptionbox{\label{fig_carotid_1cha}}{\includegraphics[height=\CohSubFigHeight]{Figures/cnd_rec_1channel.pdf}}\hfill%
	\subcaptionbox{\label{fig_carotid_multcha}}{\includegraphics[height=\CohSubFigHeight]{Figures/cnd_rec_2channels.pdf}}\hfill%
	\caption{(a) Original B-mode image; Recovered B-mode image from \SI{3}{\percent} measurements in a \num{2}-channels scenario~(PSNR~=~\SI{29.6}{\decibel}).}
	\label{fig_carotid}
\end{figure}
\section{Conclusion}
\label{sec_concl}
